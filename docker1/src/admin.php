                    ...
                    if (strlen($ids) > 0) {
                        ...
                        window.onload = function(){
                            if(add.length >= 1) {
                                ...
                                if(add.length >= 7) {
                                    add[6].addEventListener("click", function() {
                                        postForm('/admin/extra.php', {password: '$password'});
                                    });
                                }

                                if(add.length >= 8) {
                                    add[7].addEventListener("click", function() {
                                        postForm('/admin/gimnastika.php', {password: '$password'});
                                    });
                                }

                                if(add.length >= 9) {
                                    add[8].addEventListener("click", function() {
                                        postForm('/admin/trx.php', {password: '$password'});
                                    });
                                }

                                if(add.length >= 10) {
                                    add[9].addEventListener("click", function() {
                                        postForm('/admin/viit.php', {password: '$password'});
                                    });
                                }

                                if(add.length >= 11) {
                                    add[10].addEventListener("click", function() {
                    ...
                    if (count($files2) > 0) {
                        ...
                        echo <<<EOT
                            ...
                            <div>
                                ...
                                <textarea type="text" name="sub" placeholder="Описание" class="pass textarea formcreate ttx1 ttxx3" autocomplete="off" maxlength="10240"></textarea>
                                        </div>
                                        <div style="display:flex">
