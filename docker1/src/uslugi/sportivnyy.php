            ...
            <div class="content-w">
                    ...
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                                Любой серьезный спортсмен или врач знает: если вы регулярно занимаетесь спортом или
                                физкультурой, то должны совмещать свои занятия с регулярным посещением спортивного
                                массажа.
                                <br><br>
                                Он уменьшит риск получения травмы, ускорит восстановление после тренировок и улучшит
                                работу организма в целом.
                                <br><br>
                                <b id="blue">Кому подходит?</b>
                                <br>
                                Всем, кто хочет улучшить гибкость, легкость, снять болезненность мышц или избавиться от
                                постуральной и скелетно-мышечной боли.
                                <br><br>
                                Он предназначен для того, чтобы улучшить эффективность тренировок, уменьшить боль и
                                травмы в спорте.
                                <br><br>
                                Спортивный Массаж не является расслабляющим. Это специальная терапия, призванная
                                повысить качество движения и выполнения упражнения, ускорить восстановление после
                                травмы, облегчить боль, если она возникает.
                            </article>
                        </div>
                    </div>
                    <div class="c-item">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/25.png">
                    </div>
                </div>
                ...
                <div class="c-body" style="display: flex;flex-direction: row-reverse">
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                                <b id="blue">Что вы получите в результате?</b><br>
                                Спортивный массаж помогает бороться с последствиями травм и негативного влияния
                                интенсивных и/или частых спортивных или фитнес-тренировках.
                                <br><br>
                                Он облегчает боль в мышцах и улучшает подвижность суставов, помогая организму лучше
                                двигаться и восстанавливаться после тренировок быстрее. Он ускоряет заживление травм
                                мягких тканей, стимулируя поток крови, несущий кислород и питательные вещества, помогает
                                при лечении мышечного гипертонуса.
                                <br><br>
                                Также спортивный массаж снимает стресс, улучшает психическое и физическое расслабление,
                                улучшает настроение.
                            </article>
                    ...
                    <div class="c-item" style="margin-top: auto; margin-bottom: auto">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/26.png">
                    </div>
                </div>
            </div>
        </div>
