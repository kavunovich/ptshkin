...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Интервальная тренировка</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="foot" style="padding: 10px;">
        <hh1>Интервальная тренировка</hh1>
    </div>
    <div class="content" style="padding-bottom: 1%;">
            <div class="content-w">
                <div class="c-body" style="display: flex;margin-bottom: 50px; align-items:center">
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                            ВИИТ — или (Высокоинтенсивный Интервальный Тренинг) — это интервальная тренировка, которая
                            выполняется в интенсивном темпе. Используется для повышения силы, выносливости и уменьшения
                            веса.
                            <br><br>
                            <h3 id="blue">Кому подойдёт?</h3>
                            Всем, независимо от опыта и уровня физической подготовки.
                            <br><br>
                            Формат индивидуального занятия поможет тренеру постоянно взаимодействовать именно с вами,
                            более эффективно работать и корректировать вашу программу.
                            </article><br>
                        </div>
                    </div>
                    <div class="c-item">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/8.png">
                    </div>
                </div>

                <div class="c-body" style="display: flex;flex-direction: row-reverse; align-items:center">
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                            <h3 id="blue">Что будет на занятии?</h3>
                            Вы будете чередовать интенсивные анаэробные упражнения с меньшими паузами на восстановление. Вас ждёт масса
                            разнообразных упражнений, способных увеличить вашу силу, выносливость, скорость.
                            <br><br>
                            <h3 id="blue">Какой результат вы получите?</h3>
                            Эти тренировки помогут вам в короткое время улучшить форму, придать тонус мышцам без набора
                            массы. Вы будете быстро сжигать калории и улучшать кровеносную систему. И самое главное — вы
                            станете прекрасно себя чувствовать.
                            </article><br>
                    ...
                    <div class="c-item" style="margin-top: auto; margin-bottom: auto">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/9.png">
                    </div>
                </div>
            </div>
        </div>
