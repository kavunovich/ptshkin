...
<html>
    ...
    <body>
        ...
        <div class="foot" style="padding: 10px">
            <hh1>До родов и после</hh1>
        </div>
        <div class="content" style="padding-bottom: 1%">
            <div class="content-w">
                <div class="c-body" style="display: flex; align-items:center; margin-bottom: 15%">
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                            Беременность — это время существенных изменений для тела. Наши занятия являются отличным
                            способом помочь вашему организму справиться с изменениями и подготовить его к будущим
                            нагрузкам.
                            <br><br>
                            Если вы, готовясь стать матерью, регулярно тренировались, то можно рассчитывать на более
                            легкие роды и снижение дискомфорта нижней части спины и тазовой области.
                            <br><br>
                            Мы применяем только персонально подобранные упражнения, которые полностью безопасны для
                            матери и ребенка.
                            </article><br>
                        </div>
                    </div>
                    <div class="c-item">
                        <img style="width: 100%;" src="/res/311.png">
                    </div>
                </div>

                <div class="c-body" style="display: flex;flex-direction: row-reverse;align-items:center; margin-bottom: 5%">
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                                Пожалуйста, обратите внимание, если вы находитесь на третьем триместре беременности и не
                                посещали занятия на ранних сроках, начинать на данном этапе небезопасно.
                                <br><br>
                                Пренатальные тренировки учитывают меняющиеся потребности женского тела, чтобы обеспечить
                                эффективную тренировку с первого триместра беременности.
                                <br><br>
                                <b id="blue">Какой результат вы получите?</b><br>
                                <ol style="display: block" class="ul16">
                                    <li>Вам будет легче справляться с процессом родов, а также с нагрузками последующих месяцев;
                                    </li>
                                    <li>Пренатальный тренинг поможет улучшить вашу иммунную систему и кровообращение;
                                    </li>
                                    <li>Посещение занятий во время и после беременности поможет Вам вернуться в форму быстрее.
                                    </li>
                                </ol>
                            </article><br>
                    ...
                    <div class="c-item" style="margin-top: auto; margin-bottom: auto">
                        <img style="width: 100%" src="/res/3.png">
                    </div>
                </div>
            </div>
        </div>
