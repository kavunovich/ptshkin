                ...
                <div class="c-body" style="display: flex;margin-bottom: 50px">
                    <div class="c-item">
                        <div>
                            ...
                            Этот класс направлен на увеличение гибкости, растяжки и мобильности суставов.
                            <br><br>
                            Мы используем в нём малое оборудование и реформер. Благодаря этому удаётся изолировать и
                            удлинить определенные мышцы, растянуть их более глубоко и эффективно, без посторонней
                            помощи.
                            <br><br>
                            Тренер будет давать вам различные упражнения для улучшения гибкости. Вы увидите улучшение
                            состояния всего тела, но мы концентрируем особое внимание на проблемных зонах мышечных
                            групп, наиболее пострадавших от мышечных дисбалансов.
                            <br><br>
                            <h3 id="blue">Кому подойдёт?</h3>
                            Всем. Конкретного уровня физической подготовки или опыта не требуется. Даже если вы восстанавливаетесь после травмы, отсутствует гибкость вокруг крупных суставов (коленей, бедер и плеч), наши занятия для Вас.
                            </article><br>
                        </div>
                    </div>
                    <div class="c-item" style="vertical-align: top;">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/41.png">
                    </div>
                </div>
                ...
                <div class="c-body" style="display: flex;flex-direction: row-reverse">
                    <div class="c-item">
                        <div>
                            ...
                            Акцент делается на безопасные полные движения, чтобы улучшить и увеличить диапазон работы многих суставов тела.
                            <br><br>
                            Вы будете исследовать, как чувствует себя та или иная связка или мышца, чтобы ее растянуть, что позволяет организму ощущать себя свободнее.
                            <br><br>
                            <h3 id="blue">Какой результат вы получите?</h3>
                                <ul class="vispx">
                                    <li>Повышение гибкости и отличное самочувствие.
                                    </li>
                                    <li>Вы будете чувствовать себя более свободным и наслаждаться движением. Растяжка — отличный способ освобождения от стрессов — физических и эмоциональных.
                                    </li>
                                </ul>
                            </article><br>
                    ...
                    <div class="c-item" style="margin-top: auto; margin-bottom: auto">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/5 (1).png">
                    </div>
                </div>
            </div>
        </div>
