...
<html>
    <head>
        ...
        <title>Реабилитация для детей</title>
    ...
    <div class="body1">
        <div class="lb" style="background: #00b5cc; margin-top: 75px; padding-bottom: 0">
            <div class="content-w">
                <div class="lb-i">
                    <h1 style="color: white; font-size: 36px">РЕАБИЛИТАЦИЯ ДЛЯ ДЕТЕЙ</h1>
                    <h1 style="color: white; font-size: 24px">устраняем боль, восстанавливаем после травм и операций</h1>
                    <div style="font-size: 18px; background: #bcf7ff; padding: 8px; border-radius: 10px;">
                        <span >Для избежания возможных негативных последствий, которые могут проявиться даже через несколько лет, любая травма или операция требует своевременной реабилитации в начальный период.</span>
                    </div>
                    <button class="btn-req btn-req3" style="margin-top: 5%; margin-bottom: 25%">ЗАПИСАТЬСЯ</button>
                </div>
                <div class="lb-i" style="display: flex; align-items: end">
                    <img src="/res/14.png" style="width: 100%; position: absolute; right: 10vw" id="bannerr">
                </div>
            </div>
        </div>
        <div class="content">
            ...
            <div class="container nobr" style="margin-top: 10%; margin-bottom: 10%">
                <div class="reversed" style="align-items: center">
                    <img src="/res/14.png" class="imgnobr" style="float:right; margin: 0; margin-left: 20px">
                    <div style="height: auto; display: flex; align-items: center; font-size: 16px; line-height: 1.55">
                        <div>
                        Дети постоянно находятся в движении. Их организм развивается, происходит становление систем и
                        органов. Важно не только играть с ребёнком, в подвижные игры, но и полноценно развивать его
                        физически — заниматься гимнастикой.
                        <br><br>
                        Даже если нет медицинских показаний, детям с особенностями здоровья лечебная физкультура (ЛФК)
                        помогает правильно развиваться и восстанавливаться после перенесённых заболеваний или травм.-
                        часть программы
                        <h4 id="blue">Лечебная физкультура для детей назначается при таких заболеваниях:</h4>
                            <ul style="display: block">
                                <li>Пневмония
                                </li>
                                <li>Врожденная кривошея
                                </li>
                                <li>Дисплазия тазобедренного сустава
                                </li>
                                <li>Ревматизм
                                </li>
                                <li>Бронхиальная астма
                                </li>
                                <li>Нарушения осанки
                                </li>
                                <li>Плоскостопие
            ...
            <div class="container nobr">
                <div class="reversed" style="margin-top: 10%; margin-bottom: 10%">
                    <img src="/res/15.png" class="imgnobr" style="width:150px;float:right">
                    <div style="height: auto; display: flex; align-items: center; font-size: 16px; line-height: 1.55">
                        <div>
                            Важно вовремя начать комплекс ЛФК в детском возрасте. Если не лечить заболевание, ребёнок будет
                            отставать в развитии, могут появиться функциональные нарушения.
                            <br><br>
                            После курса ЛФК улучшается обмен веществ, предотвращается деформация опорно-двигательного
                            аппарата, отставание в росте и развитии. Правильная техника и своевременные меры способны как
                            улучшить прогноз, так и отменить диагноз.
                            <br><br>
                            ЛФК для детей имеет отличительные черты. В основе — большое количество игровых упражнений.
                            Программы зависят от возраста, диагноза, также учитывают уровень развития ребёнка, особенности
                            психики и моторики.
                            <br><br>
                            <b>
                                Мы используем индивидуальный подход к каждому ребёнку. У нас работают не только тренеры, но и специалисты с медицинским
                                образованием. Это гарантирует, что занятия обязательно пойдут ребёнку на пользу и не принесут ему вред.
                            </b>
...
<script>
    ...
    function mode() {
        ...
        if(window.innerWidth < 1200) {
                ...
                lb_i[0].style.filter = "none";
                lb_i[0].style.textAlign = "center";
                lb_i[1].style.width = "100%";
                lb_i[1].style.height = "auto";
                lb_i[1].style.display = "flex";
                lb_i[1].style.justifyContent = "center";
                bannerr.style.height = "auto";
                bannerr.style.width = "100%";
                bannerr.style.position = "relative";
                bannerr.style.right = "0";
                btn.style.marginBottom = "0";

                for (let i = 0; i < nobrimg.length; i++) {
                    nobrimg[i].style.width = "100%";
                        nobrimg[i].style.height = "auto";
                }
                ...
                lb_i[0].style.width = "50%";
                lb_i[0].style.zIndex = "1";
                lb_i[0].style.textAlign = "left";
                lb_i[1].style.width = "50%";
                bannerr.style.transform = "translateY(0)";
                bannerr.style.height = "auto";
                bannerr.style.position = "absolute";
                bannerr.style.width = "50%";
                bannerr.style.right = `calc((90vw - ${lb.clientWidth}px) / 2)`;
