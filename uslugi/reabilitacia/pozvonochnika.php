...
<html>
    <head>        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <title>Реабилитация позвоночника</title>
    ...
    <div class="body1">
        <div class="lb" style="background: #00b5cc; margin-top: 75px; padding-bottom: 0">
            <div class="content-w">
                <div class="lb-i">
                    <h1 style="color: white; font-size: 36px">РЕАБИЛИТАЦИЯ ПОЗВОНОЧНИКА</h1>
                ...
                <div class="lb-i" style="display: flex; align-items: end">
                    <img src="/res/16.webp" style="width: 100%; position: absolute; right: 10vw" id="bannerr">
                </div>
            </div>
        </div>
        <div class="content">
            ...
            <div class="container nobr" style="margin-top: 10%; margin-bottom: 10%">
                <div class="reversed" style="align-items: center">
                    <img src="/res/16.webp" class="imgnobr" style="float:right; margin: 0; margin-left: 20px">
                    <div style="height: auto; display: flex; align-items: center; font-size: 16px; line-height: 1.55">
                        <div>
                        Проблемы с позвоночником и хронические боли в спине — частая жалоба даже среди молодых людей.
                        Всё это снижает качество жизни, ограничивает двигательную активность, негативно влияет на
                        эмоциональное состояние человека.
                        <br><br>
                        Наша методика реабилитации — это комплекс мер для предотвращения рецидива заболевания,
                        направленных на компенсацию ограничений, вызванных болезнью, а также на восстановление, полное
                        или частичное, функций позвоночника и расположенных рядом тканей.
                        <br><br>
                        Медикаментозная терапия является первым этапом лечения, однако обычно избавляет от проблемы на
                        короткий срок.
                        <br><br>
                        А вот комплексный реабилитационный подход, учитывающий все патофизиологические нюансы
                        заболевания, ставит своей целью и способен избавить от боли на длительное время, улучшить общее
                        состояние пациента и предотвратить вторичные осложнения.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container nobr">
                <div class="reversed" style="margin-top: 10%; margin-bottom: 10%">
                    <img src="/res/17.png" class="imgnobr" style="width:150px;float:right">
                    <div style="height: auto; display: flex; align-items: center; font-size: 16px; line-height: 1.55">
                        <div>
                            <h4 id="blue">В чём причина болей в спине?</h4>
                            Это может быть физическая перегрузка мышц спины, сколиоз, грыжи межпозвонковых дисков, реже
                            — опухоли или инфекции тканей позвоночника.
                            <h4 id="blue">Когда начинать реабилитацию?</h4>
                            Сразу, как только миновал острый период: купирован болевой синдром, снят отек и остановлен
                            воспалительный процесс.
                            <br><br>
                            Даже небольшая отсрочка может привести к значительному ухудшению двигательных функций и
                            затруднит дальнейшее восстановление.
...
<script>
    ...
    function mode() {
        ...
        if(window.innerWidth < 1200) {
                ...
                bannerr.style.right = `calc((100vw - ${lb.clientWidth}px) / 2)`;
