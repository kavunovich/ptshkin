            ...
            <div class="content-w">
                <div class="c-body" style="display: flex;margin-bottom: 50px">
                    <div class="c-item">
                        <div>
                            ...
                            TRX — упражнения на специальных тренажёрах. Вам придётся научиться работе с весом
                            собственного тела, сохранять положение в пространстве на протяжении каждого упражнения,
                            задействуя больше мышц, и сжигая больше калорий.
                            <br><br>
                            Вы также будете работать на получение правильной осанки и укрепление мышечного корсета.
                            <br><br>
                            <h3 id="blue">Кому подойдёт?</h3>
                            Вам не нужно никакого опыта в TRX, но вы должны быть готовыми к тяжелой нагрузке. Это жесткий, энергичный и ориентированный на результат тренинг, который способен разогреть ваши мышцы и заставить сердце биться чаще.
                            </article><br>
                        </div>
                    </div>
                    <div class="c-item" style="vertical-align: top;">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/noroot.png">
                    </div>
                </div>
                ...
                <div class="c-body" style="display: flex;flex-direction: row-reverse">
                    <div class="c-item">
                        <div>
                            <article style="font-size: 16px">
                            <h3 id="blue">Что будет на занятии?</h3>
                            <ul class="vispx">
                                    <li>Вас ждёт интересный, разнообразный и персональный тренинг, как и все занятия в студии «ONE».
                                    </li>
                                    <li>Разминка использует методы пилатеса, чтобы растянуть и подготовить стабилизирующие мышцы и настроить вас на более сложные упражнения.
                                    </li>
                                    <li>Вы будете энергично работать, задействуя в одном упражнении различные группы мышц и при этом четко контролируя своё тело. В конце тренировки — вновь растяжка мышц для более быстрого восстановления.
                                    </li>
                                </ul>
                            <h3 id="blue">Какой результат вы получите?</h3>
                            ONE TRX быстро обеспечивает видимые глазом результаты. Укрепление локальных и глобальных мышц в итоге создает правильное
                            и красивое тело. Вы ощутите ускорение метаболизма, укрепление мышечной структуры тела и улучшение вестибулярного
                            аппарата.
                            </article><br>
                    ...
                    <div class="c-item" style="margin-top: auto; margin-bottom: auto">
                        <img style="width: 100%; margin-bottom: 25%;" src="/res/11.png">
                    </div>
                </div>
            </div>
        </div>
